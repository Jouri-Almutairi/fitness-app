    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          <h3>💪 FitZone</h3>
          <p>
            Your ultimate fitness companion. Discover thousands of exercises 
            and build your perfect workout routine.
          </p>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2024 FitZone. All rights reserved. Built with ❤️ for fitness lovers.</p>
      </div>
    </footer>
  )
}
