...
const Exercises = () => {
  ...
  // Fetch exercises from PHP Proxy (hides API key)
  useEffect(() => {
    const fetchExercises = async () => {
      setLoading(true)
      try {
        const response = await fetch(
          '/api/exercises/proxy.php?endpoint=exercises&limit=100&offset=0'
        )
  ...
  return (
    <div className="exercises-page">
      ...
      <div className="page-header">
        ...
        <p>Discover {exercises.length}+ exercises to build your perfect workout</p>
      </div>
